function transformMOHIDinputs_3D(conf_name,confOGCM_name) %IJR 12Nov19 I've changed ouputs by inputs
% TRANSFORM OGCM outputs (SARCCM FVCOM version) to TrackMPD format
% M. Desai & I.Jalón-Rojas 16 Sept 2019 modification of I.Jalon-Rojas  8 July 2019; based on LoadFVCOMFiles_3D
...
% Time
	...
	%	alltimes_str = [alltimes_str, time_str];
    	...
    	save([conf.Data.BaseDir '/TrackMPDInput' num2str(file_index) '.mat'],'u','v','w','E','time','time_str','depth');
    	count = count -1;
