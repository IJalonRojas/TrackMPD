function [ ln, lt, h, ts ] = particle_track_ode_grid_LonLat(Lon, Lat, ZZ, ux, uy, uz, VerticalLayer, Coordinates, ...
                                                  varargin )
...
if strcmpi(VerticalLayer,'sigma2DepthVar') || strcmpi(VerticalLayer,'hybrid')
