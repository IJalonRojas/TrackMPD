function [ln_ADV,lt_ADV,h_ADV] = AdvectionSchemes(Scheme,longitude,latitude,Depths,TTs,Us,Vs,Ws,LL1,LL2,LL3,Time,TimeStepCalc,Direction)
...
elseif strcmpi(Scheme,'RK2')
  ...
  UU2=interpTrackMPD(longitude,latitude,Depths,TTs,Us,[ln_ADV,lt_ADV,h_ADV],Time+Direction*TimeStepCalc);
  VV2=interpTrackMPD(longitude,latitude,Depths,TTs,Vs,[ln_ADV,lt_ADV,h_ADV],Time+Direction*TimeStepCalc);
  WW2=interpTrackMPD(longitude,latitude,Depths,TTs,Ws,[ln_ADV,lt_ADV,h_ADV],Time+Direction*TimeStepCalc);
...
elseif strcmpi(Scheme,'RK4')
  ...
  UU2=interpTrackMPD(longitude,latitude,Depths,TTs,Us,[ln_ADV,lt_ADV,h_ADV],Time+Direction*0.5*TimeStepCalc);
  VV2=interpTrackMPD(longitude,latitude,Depths,TTs,Vs,[ln_ADV,lt_ADV,h_ADV],Time+Direction*0.5*TimeStepCalc);
  WW2=interpTrackMPD(longitude,latitude,Depths,TTs,Ws,[ln_ADV,lt_ADV,h_ADV],Time+Direction*0.5*TimeStepCalc);
  ...
  UU3=interpTrackMPD(longitude,latitude,Depths,TTs,Us,[ln_ADV,lt_ADV,h_ADV],Time+Direction*0.5*TimeStepCalc);
  VV3=interpTrackMPD(longitude,latitude,Depths,TTs,Vs,[ln_ADV,lt_ADV,h_ADV],Time+Direction*0.5*TimeStepCalc);
  WW3=interpTrackMPD(longitude,latitude,Depths,TTs,Ws,[ln_ADV,lt_ADV,h_ADV],Time+Direction*0.5*TimeStepCalc);
  
  ln_ADV=LL1+Direction*UU3*TimeStepCalc;
  lt_ADV=LL2+Direction*VV3*TimeStepCalc;
  h_ADV=LL3+Direction*WW3*TimeStepCalc;
  UU4=interpTrackMPD(longitude,latitude,Depths,TTs,Us,[ln_ADV,lt_ADV,h_ADV],Time+Direction*TimeStepCalc);
  VV4=interpTrackMPD(longitude,latitude,Depths,TTs,Vs,[ln_ADV,lt_ADV,h_ADV],Time+Direction*TimeStepCalc);
  WW4=interpTrackMPD(longitude,latitude,Depths,TTs,Ws,[ln_ADV,lt_ADV,h_ADV],Time+Direction*TimeStepCalc);
