function [ln_ADV,lt_ADV] = AdvectionSchemes2D(Scheme,longitude,latitude,TTs,Us,Vs,LL1,LL2,Time,TimeStepCalc,Direction)
...
elseif strcmpi(Scheme,'RK2')
  ...
  UU2=interpTrackMPD_2D(longitude,latitude,TTs,Us,[ln_ADV,lt_ADV],Time+Direction*TimeStepCalc);
  VV2=interpTrackMPD_2D(longitude,latitude,TTs,Vs,[ln_ADV,lt_ADV],Time+Direction*TimeStepCalc);
...
elseif strcmpi(Scheme,'RK4')
  ...
  UU2=interpTrackMPD_2D(longitude,latitude,TTs,Us,[ln_ADV,lt_ADV],Time+Direction*0.5*TimeStepCalc);
  VV2=interpTrackMPD_2D(longitude,latitude,TTs,Vs,[ln_ADV,lt_ADV],Time+Direction*0.5*TimeStepCalc);
  
  ln_ADV=LL1+Direction*UU2*0.5*TimeStepCalc;
  lt_ADV=LL2+Direction*VV2*0.5*TimeStepCalc;
  UU3=interpTrackMPD_2D(longitude,latitude,TTs,Us,[ln_ADV,lt_ADV],Time+0.5*Direction*TimeStepCalc);
  VV3=interpTrackMPD_2D(longitude,latitude,TTs,Vs,[ln_ADV,lt_ADV],Time+0.5*Direction*TimeStepCalc);
  
  ln_ADV=LL1+Direction*UU3*TimeStepCalc;
  lt_ADV=LL2+Direction*VV3*TimeStepCalc;
  UU4=interpTrackMPD_2D(longitude,latitude,TTs,Us,[ln_ADV,lt_ADV],Time+Direction*TimeStepCalc);
  VV4=interpTrackMPD_2D(longitude,latitude,TTs,Vs,[ln_ADV,lt_ADV],Time+Direction*TimeStepCalc);
