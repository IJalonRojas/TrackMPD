classdef behaviour4
    %% 
    %BEHAVIOUR4 contains all the MPD Geoometical,Physical, and/orBiological 
    % Features needed tro track microplastics with the behaviour 4
    %
    % beh=4: microplastic (shape,size,density), Biofouling (stationary), no degradation
    %
    % Water properties
    %   WaterDensity
    %   WaterViscosity
    ...
    methods
        ...
        function P = set.BiofoulingThickness(P, newBiofoulingThickness)
            if newBiofoulingThickness>0
                ...
                error('Invalid BiofoulingThickness for Behaviour 4');
            end
        end
         ...
         function P = set.FilmDensity(P, newFilmDensity)
            if newFilmDensity>0
                ...
                error('Invalid Film Density for Behaviour 4');
            end
        end
