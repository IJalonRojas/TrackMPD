classdef behaviour3
    %% 
    %BEHAVIOUR3 contains all the MPD Geoometical,Physical, and/orBiological 
    % Features needed tro track microplastics with the behaviour 3
    %
    % beh=3:  microplastic (shape,size,density), plastic density>1 g cm^-3, no biofouling, no degradation
    %
    % Water properties
    %   WaterDensity
    %   WaterViscosity
