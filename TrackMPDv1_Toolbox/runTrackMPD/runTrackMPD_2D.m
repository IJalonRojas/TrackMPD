function a = runTrackMPD_2D(conf_name)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This script run TrackMPD model (2D mode)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% 	$Id: runTrackMPD_2D.m 001 2018-02-12 10:55:10Z ef $
%        Las version: 2018-06-19 ijalonrojas
%
% Copyright (C) 2014-2018 Isabel Jalon-Rojas & Erick Fredj
...
for k=1:numpartition % EXTERNAL LOOP
    ...
    %Initialize variables ZC !! will make all results nan
...
%         if strcmpi(conf.Traj.Windage,'no')
            ...
            [ln_ADV,lt_ADV,ts_a] = feval( 'particle_track_ode_grid_LonLat2D',Lon,Lat,...
                                   U,V,TT,tspan,LL,options);
